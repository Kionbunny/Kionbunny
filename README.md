...
I specialize in JavaScript, TypeScript, and frameworks like React.js and Angular for the front end, while leveraging Node.js and Express on the backend, with Azure cloud services for deployment. My passion lies in crafting clean, maintainable code, optimizing performance, and continuously learning emerging technologies.
